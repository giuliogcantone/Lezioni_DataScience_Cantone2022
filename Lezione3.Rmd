...
- `mutate`: aggiunge o sostituisce una colonna, in funzione di una o più colonne pre-esistenti
...
- I 'join' servono a prendere una o più colonne da una tabella ed innestarle in un altra secondo un criterio di corrispondenza rispetto a una o più colonne i comune tra le due tabelle.
